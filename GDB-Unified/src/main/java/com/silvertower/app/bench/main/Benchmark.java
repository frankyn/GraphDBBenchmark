...
//		initializers.add(new OrientWrapper());
	...
	public void benchmark(String currentDBName) {
		...
		bps0.addResult("Load", executor.loadBench(new LoadWorkload(10000, d)));
...
//		
		...
		bps41.addResult("100 reads", 100, executor.workBench(new GetVerticesByPropIntensiveWorkload(100, 1, false)));
