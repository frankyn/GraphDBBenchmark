package com.silvertower.app.bench.loading;
...
public class CustomGraphMLReader {
	
	/**
	 * This class is simply a modified version of Tinkerpop's GraphMLReader class.
	 * It loads the graph incrementally and measures the loading time. 
	 */
	
	public LoadResults results;
     ...
     */
	public CustomGraphMLReader(Graph graph) {
		this.graph = graph;
	}
     ...
     * @throws IOException thrown when the GraphML data is not correctly formatted
     */
    public void inputGraph(final Graph inputGraph, final String filename, int bufferSize, String vertexIdKey, String edgeIdKey, String edgeLabelKey) throws IOException {
     ...
     * @throws IOException thrown when the GraphML data is not correctly formatted
     */
    public void inputGraph(final Graph inputGraph, final InputStream graphMLInputStream, int bufferSize, String vertexIdKey, String edgeIdKey, String edgeLabelKey) throws IOException {
